...
/**
 * Servlet implementation class GetDataOflostChildren
 */
@WebServlet("/GetDataOflostChildren")
@MultipartConfig(maxFileSize = 16177215)
public class GetDataOflostChildren extends HttpServlet {
...
//		String username=(String)session.getAttribute("user");
		...
		System.out.println(lati+"_"+longi);
		 ...
		 BufferedImage newImg;
	      ...
	      String sql = "INSERT INTO product(category,quantity,price,username,instruction,status,location) values (?, ?, ?,?,?,?,?)";
...
//		   			psmt.setBlob(1, is);
				...
				String query1="update product set imagefile=? where id="+id;
